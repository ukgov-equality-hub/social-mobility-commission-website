...
<h4 style="margin-top: 30px;"><?php _e('For each record in this import file, every time this import is run...', 'wp-all-import-pro'); ?></h4>
<?php else: ?>
<h4 style="margin-top: 30px;"><?php _e('For each record in this import file, every time this import is run...', 'wp-all-import-pro'); ?></h4>
<?php endif; ?>
<?php
...
<div class="input">
	...
	<a href="#help" class="wpallimport-help" style="position: relative; top: -2px;" title="<?php printf(__('These options will only be used if you run this import again later. All data is imported the first time you run an import.<br/><br/>Note that WP All Import will only update/remove %s created by this import. If you want to match to %s that already exist on this site, change the setting above to "Search for and update all %s on this site".', 'wp-all-import-pro'), $cpt_name, $cpt_name, $cpt_name) ?>">?</a>
	<?php endif; ?>
	<div class="switcher-target-is_not_keep_former_posts" style="padding-left:20px;">
		...
		<div class="switcher-target-update_choosen_data"  style="padding-left:28px;">
            ...
            <div class="input">
                ...
                <div class="switcher-target-is_update_comments" style="padding-left:20px;">
			...
			<div class="input">
				...
				<div class="switcher-target-is_update_images" style="padding-left:20px;">
					<div class="input" style="margin-bottom:3px;">
			...
			<div class="input">
				...
				<div class="switcher-target-is_update_categories" style="padding-left:20px;">
					<?php
					...
					<div class="input" style="margin-bottom:3px;">
						...
						<div class="switcher-target-update_categories_logic_all_except pmxi_choosen" style="padding-left:20px;">
					...
					<div class="input" style="margin-bottom:3px;">
						...
						<div class="switcher-target-update_categories_logic_only pmxi_choosen" style="padding-left:20px;">
							<span class="hidden choosen_values"><?php if (!empty($existing_taxonomies)) echo esc_html(implode(',', $existing_taxonomies));?></span>
