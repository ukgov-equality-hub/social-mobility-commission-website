...
class ResearchAndStatsIndex extends Post
{
    ...
    protected static function getPostTypeConfig(): ?array
    {
        return [
            'labels'        => [
                'name'          => __('Research And Stats Index'),
                'singular_name' => __('Research And Stats Index'),
                'add_new_item'  => __('Add New Research And Stats Index'),
            ],
            'public'        => true,
            //'taxonomies' => [],
