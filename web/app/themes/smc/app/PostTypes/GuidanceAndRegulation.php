...
class GuidanceAndRegulation extends Post
{
    ...
    protected static function getPostTypeConfig(): ?array
    {
        return [
            'labels'        => [
                'name'          => __('Guidance And Regulation'),
                'singular_name' => __('Guidance And Regulation'),
                'add_new_item'  => __('Add New Guidance And Regulation'),
            ],
            'public'        => true,
            //'taxonomies' => [],
            ...
            'show_in_menu'  => true,
            'show_in_rest'  => true,
//            'has_archive'   => 'guidance-and-regulation',
            //            'rewrite' => [
            //                'slug' => 'product',
            //                'with_front' =>  true,
            //                'pages' => true,
