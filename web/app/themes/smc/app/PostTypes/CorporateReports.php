...
class CorporateReports extends Post
{
    ...
    protected static function getPostTypeConfig(): ?array
    {
        return [
            'labels'        => [
                'name'          => __('Corporate Reports'),
                'singular_name' => __('Corporate Report'),
                'add_new_item'  => __('Add New Corporate Report'),
            ],
            'public'        => true,
            //'taxonomies' => [],
