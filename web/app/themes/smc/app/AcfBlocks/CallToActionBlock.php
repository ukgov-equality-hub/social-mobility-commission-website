 ...
 *
 *
 * Location : Block value acf/zsty-call-to-action
 */
class CallToActionBlock extends AbstractAcfBlock
{
    // IF NOT ALREADY DONE SO _ READ THE CLASS COMMENTS ABOVE AND THE README.

    protected static string $template         = 'acf-blocks/call-to-action.twig';

    public string           $blockTitle       = 'Call To Action';

    public string           $blockDescription = 'Zesty content block, with title - text and button';
