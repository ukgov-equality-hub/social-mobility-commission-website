 ...
 *
 *
 * Location : Block value acf/zsty-general-quote
 */
class GeneralQuote extends AbstractAcfBlock
{
    // IF NOT ALREADY DONE SO _ READ THE CLASS COMMENTS ABOVE AND THE README.

    protected static string $template         = 'acf-blocks/general-quote.twig';

    public string           $blockTitle       = 'General Quote';

    public string           $blockDescription = 'Zesty content block, with quote, name and role fields.';
