 ...
 *
 *
 * Location : Block value acf/zsty-how-can-we-help
 */
class HowCanWeHelp extends AbstractAcfBlock
{
    // IF NOT ALREADY DONE SO _ READ THE CLASS COMMENTS ABOVE AND THE README.

    protected static string $template         = 'acf-blocks/how-we-can-help.twig';

    public string           $blockTitle       = 'How Can We Help';

    public string           $blockDescription = 'Zesty content block, with title, subtitle and link cards';
