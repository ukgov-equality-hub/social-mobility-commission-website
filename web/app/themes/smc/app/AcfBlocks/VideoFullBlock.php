 ...
 *
 *
 * Location : Block value acf/zsty-video-full-block
 */
class VideoFullBlock extends AbstractAcfBlock
{
    // IF NOT ALREADY DONE SO _ READ THE CLASS COMMENTS ABOVE AND THE README.

    protected static string $template         = 'acf-blocks/video-full.twig';

    public string           $blockTitle       = 'Video Full Block';

    public string           $blockDescription = 'Zesty content block, with full width Video';
