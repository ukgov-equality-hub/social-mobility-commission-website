 ...
 *
 *
 * Location : Block value acf/zsty-image-full-block
 */
class ImageFullBlock extends AbstractAcfBlock
{
    // IF NOT ALREADY DONE SO _ READ THE CLASS COMMENTS ABOVE AND THE README.

    protected static string $template         = 'acf-blocks/image-full.twig';

    public string           $blockTitle       = 'Image Full Block';

    public string           $blockDescription = 'Zesty content block, with full width image';
