 ...
 *
 *
 * Location : Block value acf/zsty-stats
 */
class Stats extends AbstractAcfBlock
{
    // IF NOT ALREADY DONE SO _ READ THE CLASS COMMENTS ABOVE AND THE README.

    protected static string $template         = 'acf-blocks/stats.twig';

    public string           $blockTitle       = 'Stats';

    public string           $blockDescription = 'Zesty content block, with statistics and text';
