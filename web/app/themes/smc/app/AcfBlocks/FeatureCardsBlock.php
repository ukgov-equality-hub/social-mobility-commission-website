 ...
 *
 *
 * Location : Block value acf/zsty-feature-cards
 */
class FeatureCardsBlock extends AbstractAcfBlock
{
    // IF NOT ALREADY DONE SO _ READ THE CLASS COMMENTS ABOVE AND THE README.

    protected static string $template         = 'acf-blocks/feature-cards.twig';

    public string           $blockTitle       = 'Feature Cards';

    public string           $blockDescription = 'Zesty content block, with 3 Feature Cards';
