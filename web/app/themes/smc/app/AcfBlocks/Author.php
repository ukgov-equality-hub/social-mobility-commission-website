 ...
 *
 *
 * Location : Block value acf/zsty-author
 */
class Author extends AbstractAcfBlock
{
    // IF NOT ALREADY DONE SO _ READ THE CLASS COMMENTS ABOVE AND THE README.

    protected static string $template         = 'acf-blocks/author.twig';

    public string           $blockTitle       = 'Author';

    public string           $blockDescription = 'Zesty content block, with Author image, name and meta text';
