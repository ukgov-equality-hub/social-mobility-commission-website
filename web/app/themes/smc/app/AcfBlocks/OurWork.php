 ...
 *
 *
 * Location : Block value acf/zsty-our-work
 */
class OurWork extends AbstractAcfBlock
{
    // IF NOT ALREADY DONE SO _ READ THE CLASS COMMENTS ABOVE AND THE README.

    protected static string $template         = 'acf-blocks/our-work.twig';

    public string           $blockTitle       = 'Our Work';
