 ...
 *
 *
 * Location : Block value acf/zsty-card-half-and-half
 */
class CardHalfAndHalfBlock extends AbstractAcfBlock
{
    // IF NOT ALREADY DONE SO _ READ THE CLASS COMMENTS ABOVE AND THE README.

    protected static string $template         = 'acf-blocks/card-half-and-half.twig';

    public string           $blockTitle       = 'Colour background block / half with image';

    public string           $blockDescription = 'Zesty content block, with title, Text, link and image with colour background';
