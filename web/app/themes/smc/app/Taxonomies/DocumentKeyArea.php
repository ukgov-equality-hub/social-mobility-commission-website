...
class DocumentKeyArea extends AbstractTaxonomy
{

    public static function getTermType(): string
    {
        return 'document-key-area';
    }
    ...
    {
        $labels = [
            'name'          => _x('Document Key Areas', 'Taxonomy General name', 'app'),
            'singular_name' => _x('Document Key Area', 'Taxonomy singular name', 'app'),
            'menu_name'     => __('Document Key Areas', 'app'),
        ];
