...
class CaseStudyType extends AbstractTaxonomy
{
    ...
    {
        $labels = [
            'name'          => _x('Case Study Types', 'Taxonomy General name', 'app'),
            'singular_name' => _x('Case Study Type', 'Taxonomy singular name', 'app'),
            'menu_name'     => __('Case Study Types', 'app'),
        ];
