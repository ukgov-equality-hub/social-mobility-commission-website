  ...
  (function (e, t) {
    ...
    const We = {
      ...
      createButton(e, t) {
        ...
        return (
          ...
          G(a, i),
          'play' === s
            ? (D(this.elements.buttons[s]) || (this.elements.buttons[s] = []), this.elements.buttons[s].push(a))
    ...
    class st {
      ...
      static get prefix() {
        ...
        return (
          ['webkit', 'moz', 'ms'].some(
            (t) => !(!j(document[`${t}ExitFullscreen`]) && !j(document[`${t}CancelFullScreen`])) && ((e = t), !0)
          ),
          e
        )
      }
        ...
        if (
          (e(this, 'play', () =>
            j(this.media.play)
              ? (this.ads &&
                  this.ads.enabled &&
                  this.ads.managerPromise.then(() => this.ads.play()).catch(() => ke(this.media.play())),
                this.media.play())
              : null
          ),
          ...
          this.supported.api
            ? ((this.eventListeners = []),
              ...
              H(this.elements.container) ||
                ((this.elements.container = Z('div', { tabindex: 0 })), J(this.media, this.elements.container)),
