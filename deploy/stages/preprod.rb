...
# ===============================================
set :stage, :preprod
set :application, "preprod-smc.zestydev.com"
set :deploy_to, -> { "/home/szdev/sites/preprod-smc.zestydev.com/web" }
set :tmp_dir, "/home/szdev/sites/preprod-smc.zestydev.com/tmp"
...
# WP CLI Features
# ===============
set :wpcli_remote_url, "https://preprod-smc.zestydev.com"
...
fetch(:default_env).merge!(wp_env: :preprod)
